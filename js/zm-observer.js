if (/calendar.google.com/g.test(window.location.host)) {
  ...
  var xhrObserver = new (function() {
        ...
        function s(e, t, n) {
          ...
          if (t) {
            ...
            if (t) {
              if (r !== t) {
                console.log(
                  "The rule for converting nId to eid is error:",
                  r,
                  t
                );
              } else {
          ...
          this.addEventListener(
            ...
            function() {
              ...
              if (t === "event" && e === "CREATE") {
                ...
                if (
                  i &&
                  typeof i[0] !== "undefined" &&
                  typeof i[0][1] !== "undefined" &&
                  o !== ""
                ) {
                  let e = i[7][1];
                  if (typeof e === "string" && e.length > 20) {
                    window.postMessage(
                      { calendarId: e, action: "event", number: o },
                      "*"
                    );
                  }
                ...
                if (c && c.length < 128) {
                  window.postMessage(
                    { calendarId: c, action: "deleteevent" },
                    "*"
                  );
                }
                ...
                if (i) {
                  ...
                  if (o && c) {
                    ...
                    if (n.length < 4) {
                      ...
                      if (!a) {
                        console.log(
                          "The create request occurs, but sendBaseid has no value!"
                        );
                        window.postMessage(
                          {
                            event_baseid: c,
                        ...
                        if (a != c) {
                          console.log(
                            "The create request occurs, but sendBaseid is not equal to nid!"
                          );
                          window.postMessage(
                            {
                              event_baseid: c,
                      ...
                      if (r === "0" && e) {
                        ...
                        try {
                          ...
                          let i = e[35][1][0],
                            a = e[36][1][0];
                          let o = JSON.parse(
                            document.querySelector("#timezonedata").innerText
                          )[0];
                          r = e[35][2];
                          if (!r) {
                  ...
                  if (e) {
                    window.postMessage(
                      { event_baseid: c, action: "deleteevent" },
                      "*"
                    );
                  }
                }
                if (a) {
                  console.log(
                    "The sendBaseid has value, but create request does not exist!"
                  );
                  window.postMessage(
                    {
                      event_baseid: a,
          ...
          if (typeof e === "string" && e.indexOf("f.req=") >= 0) {
            ...
            if (Array.isArray(i)) {
              ...
              if (t && t.innerHTML !== "") {
                try {
                  if (i[0][4][0][2]) {
                    i[0][4][0][2][0][2][3][1][2][1] = decodeURIComponent(
                      t.innerHTML
                    );
                  } else if (i[0][4][2][2]) {
                    i[0][4][2][2][0][2][3][1][2][1] = decodeURIComponent(
                      t.innerHTML
                    );
                  }
                  n = true;
              ...
              if (n) {
                e = e.replace(
                  /f\.req\=[\w\W]*?(?=&)/,
                  "f.req=" + encodeURIComponent(JSON.stringify(i))
                );
              }
              try {
                if (i[0][4][0][2]) {
    ...
    window.addEventListener(
      ...
      function(e) {
        if (
          e.data.calendarId !== undefined ||
          e.data.event_baseid !== undefined
        ) {
